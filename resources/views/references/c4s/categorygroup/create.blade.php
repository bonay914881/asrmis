                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">Create C4s Category Group</h3>
                            </div>
                    ...
                    <div class="py-2">
                        <div class="card-body">
                            <form action="{{ route('categorygroups.store') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('post')	
                                ...
                                <div class="pl-lg-4">                                    
                                    <div class="form-group{{ $errors->has('category_group_code') ? ' has-danger' : '' }} mb-3">
                                        ...
                                        <input type="text" name="category_group_code" class="form-control{{ $errors->has('category_group_code') ? ' is-invalid' : '' }}" placeholder="{{ __('Category Group Code') }}" value="{{ old('category_group_code') }}" autofocus>
                                    ...
                                    <div class="form-group{{ $errors->has('category_group_desc') ? ' has-danger' : '' }} mb-3">
                                        ...
                                        <input type="text" name="category_group_desc" class="form-control{{ $errors->has('category_group_desc') ? ' is-invalid' : '' }}" placeholder="{{ __('Category Group Description') }}" value="{{ old('category_group_desc') }}">
