                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">Edit C4s Nomenclature</h3>
                            </div>
                    ...
                    <div class="py-2">
                        <div class="card-body">
                            <form action="{{ route('nomenclatures.update',$nomenclature) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('put')	
                                ...
                                <div class="pl-lg-4">                                    
                                    <div class="form-group{{ $errors->has('equipment_code') ? ' has-danger' : '' }} mb-3">
                                        ...
                                        <input type="text" name="equipment_code" class="form-control{{ $errors->has('equipment_code') ? ' is-invalid' : '' }}" value="{{ $nomenclature->equipment_code }}" autofocus>
                                    ...
                                    <div class="form-group{{ $errors->has('nomenclature') ? ' has-danger' : '' }} mb-3">
                                        ...
                                        <input type="text" name="nomenclature" class="form-control{{ $errors->has('nomenclature') ? ' is-invalid' : '' }}" value="{{ $nomenclature->nomenclature }}">
                                    ...
                                    <div class="form-group{{ $errors->has('classification') ? ' has-danger' : '' }} mb-3">
                                        ...
                                        <input type="text" name="classification" class="form-control{{ $errors->has('classification') ? ' is-invalid' : '' }}" value="{{ $nomenclature->classification }}">
                                    ...
                                    <div class="form-group{{ $errors->has('commo_category_id') ? ' has-danger' : '' }} mb-3">
                                        ...
                                        <select class="form-control" data-toggle="select" name="commo_category_id">
                                            ...
                                            @foreach($commocategories as $commocategory)
                                                <option value="{{ $commocategory->id }}" data-tokens="{{ $commocategory->commo_code }}" {{ ($nomenclature->commo_category_id == $commocategory->id) ? "selected" : "" }} >{{ $commocategory->commo_code }}</option>
                                            @endforeach
                                        </select>
