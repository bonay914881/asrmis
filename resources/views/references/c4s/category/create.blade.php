                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">Create C4s Category</h3>
                            </div>
                            ...
                            <form action="{{ route('category.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="pl-lg-4">                                    
                                    <div class="form-group{{ $errors->has('category_code') ? ' has-danger' : '' }} mb-3">
                                        ...
                                        <input type="text" name="category_code" class="form-control{{ $errors->has('category_code') ? ' is-invalid' : '' }}" placeholder="{{ __('Category Code') }}" value="{{ old('category_group_code') }}" autofocus>
                                    ...
                                    <div class="form-group{{ $errors->has('category_description') ? ' has-danger' : '' }} mb-3">
                                        ...
                                        <input type="text" name="category_description" class="form-control{{ $errors->has('category_description') ? ' is-invalid' : '' }}" placeholder="{{ __('Category Description') }}" value="{{ old('category_description') }}">
